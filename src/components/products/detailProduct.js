...
const DetailProduct = (props) => {
    ...
    const handleSubmitImage = async (e) => {
        ...
        let dataCreateImage = await axios.post("https://huyle-app-backend.onrender.com/api/v6/upload-multiple-pic", formData, {
            headers: {
                                                                                                        ...
                                                                                                        >
                                                                                                            ...
                                                                                                            {actionModalFour === "4" ?
                                                                                                                <>
                                                                                                                    ...
                                                                                                                    <img src={"https://huyle-app-backend.onrender.com/image/" + item.url} alt="" title='View detail image' />
